...
Description: manual k-nearest neigbor classificaiton on breast cancer data using numpy.
"""
...
[train_set[int(i[-1])].append(i[:-1]) for i in
 train_data]  # append data of the classification to the id of the classification
